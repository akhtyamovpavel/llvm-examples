...
define i32 @main() #2 {
  ...
  %1 = call %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* %s)
  %2 = load i32* %s, align 4, !tbaa !1
  %3 = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %2)
  ret i32 0
}
